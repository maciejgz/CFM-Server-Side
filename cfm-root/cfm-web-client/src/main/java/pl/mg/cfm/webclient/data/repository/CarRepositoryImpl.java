 ...
 * Hibernate) ze wsparciem Springa. Konfiugracja bazy danych po stronie Hibernate JPA (duplikacja względem Spring Data JPA w obiektach DAO, tylko do testów).
 *
 * @author Maciej Gzik
 */
...
/*        CarPojo carPojo = new CarPojo();
    ...
    public List<Car> findCars(CarCriteria criteria) throws UnsupportedOperationException {
        ...
        // TODO zrobi� zagnie�d�one queries dla ownerId
